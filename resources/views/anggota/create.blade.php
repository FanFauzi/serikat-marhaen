    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('anggota.index') }}"
                class="text-gray-500 hover:text-red-600 font-semibold text-sm transition">&larr; Batal & Kembali</a>
        </div>
    </x-slot>
                ...
                <form action="{{ route('anggota.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="dpk_asal"
                                value="{{ old('dpk_asal', 'DPK GMNI Unimma Kampus 2') }}" required
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring focus:ring-red-200 bg-gray-50">
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="alamat" rows="2"
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring focus:ring-red-200">{{ old('alamat') }}</textarea>
                        </div>
                        <div class="md:col-span-2">
                    ...
                    <div class="mt-8 flex justify-end">
                        <button type="submit"
                            class="bg-gray-900 hover:bg-red-700 text-white font-bold py-3 px-8 rounded-full shadow-lg transition-colors">
                            Simpan Data Kader
                        </button>
                    </div>
                </form>
